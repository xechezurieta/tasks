...
public class Task {
    ...
    public Task(UUID id, LocalDateTime created, TaskPriority priority, TaskStatus status, String title, String description, LocalDateTime dueDate, LocalDateTime updated) {
